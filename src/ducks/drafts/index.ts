...
import {NapiResponse, RelayerNewPostResponse} from "../../utils/types";
...
export const submitProfilePicture = () => (dispatch: ThunkDispatch<any, any, Action>, getState: () => any) => {
  const {
    drafts: {
      profilePictureUrl,
    },
...
export const submitCoverImage = () => (dispatch: ThunkDispatch<any, any, Action>, getState: () => any) => {
  const {
    drafts: {
      coverImage,
    },
