...
export const useSendPost = () => {
  ...
  return useCallback(async (draft: DraftPost): Promise<RelayerNewPostResponse> => {
    ...
    const json: NapiResponse<RelayerNewPostResponse> = await resp.json();
...
export const useLikePage = () => {
  ...
  return useCallback(async (postHash: string) => {
    try {
      ...
      const json: NapiResponse<RelayerNewReactionResponse> = await resp.json();
...
export const useFollowUser = () => {
  ...
  return useCallback(async (username: string) => {
    ...
    const json: NapiResponse<RelayerNewFollowResponse> = await resp.json();
...
export const useBlockUser = () => {
  ...
  return useCallback(async (username: string) => {
    ...
    const json: NapiResponse<RelayerNewBlockResponse> = await resp.json();
